...
public class OrangeHRM_Leave_EmployeeEntitlement_TestCase extends Library{
...
//		Thread.sleep(5000);
		addentitlement.Leave_DropLocation("  Canada");
		addentitlement.Leave_DropSubUnit("IT");
		addentitlement.Leave_DropLeavetype("Vacation US");
