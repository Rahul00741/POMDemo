...
public class OrangeHRM_Leave_Entitlements_AddEntitlement {
	/**
	 *@author Rahul
	 *@version 1.0
	 */
		...
		public OrangeHRM_Leave_Entitlements_AddEntitlement(WebDriver driver)
		{
		...
		//To check dropdwon functionality added this method once Reusable Functions are finalized then will remove it
